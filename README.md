...
La version candidate 0.1.3 introduit les révisions temporelles documentées dans [le contrat](docs/INCIDENT_REVISIONS.md). Les contrôles CPU ne qualifient pas les modèles, la production ou le rendu Unreal. La compatibilité quotidienne reste maintenue.
